...
export default function Pending({filter, selectedDate, search}) {
  ...
  const handleData = async () => {
    try {
      ...
      const response = await fetch(
        `${BASE_URL}driver/jobsByDriver?driverId=${id}`,
        {
          method: 'GET',
          headers: {
  ...
  // if (loading) {
  //   return(
  //   <View style={{width:"100%",height:"67%",backgroundColor:"rgba(0,0,0,0.2)",flexDirection:"column",alignItems:"center",justifyContent:"center",marginTop:20}}>
  //     <View style={{width:"50%",height:100,backgroundColor:"#fff",borderRadius:20,flexDirection:"column",alignItems:"center",justifyContent:"center"}}>
  ...
  //   const results =data.filter(item => isSameDay(parseISO(moment(item.createdDateTime).format('YYYY-MM-DD')) , changeDateTomorrow));
    ...
    switch (filter) {
      case 'Today':
        ...
        const responseToday = await fetch(
          `${BASE_URL}driver/jobFilter?fromDate=${todayDateFormat}`,
          {
            method: 'GET',
            headers: {
              'Content-Type': 'application/json',
      ...
      case 'Tomorrow':
        ...
        const tomorrowData = await fetch(
          `${BASE_URL}driver/jobFilter?fromDate=${tomorrowDateFormat}`,
          {
            method: 'GET',
            headers: {
              'Content-Type': 'application/json',
      ...
      case 'Yesterday':
        ...
        const yesterDate = await fetch(
          `${BASE_URL}driver/jobFilter?fromDate=${yesterDateFormat}`,
          {
            method: 'GET',
            headers: {
              'Content-Type': 'application/json',
      ...
      case 'Custom Date':
        ...
        const responseCustomToday = await fetch(
          `${BASE_URL}driver/jobFilter?fromDate=${selectDateFormat}`,
          {
            method: 'GET',
            headers: {
              'Content-Type': 'application/json',
  ...
  if (!data) {
    return (
      <View
        ...
        <Text style={{color: '#000'}}>No Job Found !!</Text>
      </View>
    );
  }
